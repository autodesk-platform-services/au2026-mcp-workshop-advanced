...
- Put an OAuth proxy of your own in front of `/mcp`, so an MCP client has to sign in — via the same Autodesk account — before it can call a single tool (Part 5).
...
- [Part 5: Client Authentication](5-client-auth.md)
- [Extras](extras.md)
